# Zeroshot Evaluation of NormWear

This markdown covers setup, downloads, and HPC usage for the repository root to run **zero-shot** evaluations.
...
[`job_script_example.sh`](job_script_example.sh) is an example of a Slurm batch script for running NormWear on an HPC cluster. It does three things:
